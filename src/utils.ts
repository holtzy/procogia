...
export const AXIS_CONFIG: AxisConfig[] = [
    ...
    { name: "ETL/ELT", max: 100 },
    { name: "Cloud Data", max: 100 },
    { name: "Big Data", max: 100 },
    { name: "Orchestration", max: 100 },
    { name: "Machine Learning", max: 100 },
    { name: "MLOps", max: 100 },
    { name: "Deep Learning", max: 100 },
    { name: "Statistics", max: 100 },
    { name: "Generative AI", max: 100 },
    { name: "Bioinformatics", max: 100 },
    { name: "EDA", max: 100 },
    { name: "SQL", max: 100 },
    { name: "BI Tools", max: 100 },
    { name: "Metadata", max: 100 },
    { name: "Governance", max: 100 },
    { name: "Research", max: 100 },
    { name: "Data Science Tools", max: 100 },
    { name: "Clinical Data", max: 100 },
    { name: "SAS", max: 100 },
];
